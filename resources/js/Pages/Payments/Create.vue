            ...
            <form @submit.prevent="submitForm" id="client-create" class="flex justify-between items-start">
                ...
                <div id="right-side" class="w-1/2">
                    ...
                    <div class="mb-8">
                        ...
                        <input v-model="form.for" class="block rounded-lg w-3/4 border-gray-400 shadow-gray-200 shadow-md py-2" type="text" id="payment-for" placeholder="EBD Online Marketing Services">
                    </div>
